...
from dataloader.cpcDataset_pic import CPCDataset_pic
from m_Loss import loss_m
...
if __name__ == '__main__':
    ...
    # 加载网络
    model_dir = '/home/zhangshuo/pic/pre/weights/2024-04-22_17_20_40/130.pth'
    ...
    for user_name in tqdm(os.listdir('/home/zhangshuo/pic/datasets/prior/total')):

        # 对一个用户提取其图片
        user_name = user_name[:-4]
        csv_file_train = '/home/zhangshuo/pic/datasets/prior/train/' + \
            user_name + '_train.csv'
        csv_file_val = '/home/zhangshuo/pic/datasets/prior/val/' + \
            user_name + '_val.csv'
