...
from dataloader.picDataset_cpc_best import CPC
...
from models.picModel_best import build_crop_model
...
if __name__ == '__main__':
    ...
    cpc_dataset = CPC(
        main_dir='/public/datasets/CPCDataset/process/user_best_images/train',
        transform=transform
    )
