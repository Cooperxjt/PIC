...
if __name__ == '__main__':
    ...
    model_dir = 'models/pretrained_model/mobilenet_0.625_0.583_0.553_0.525_0.785_0.762_0.748_0.723_0.783_0.806.pth'
    ...
    # 获取文件列表
    file_list = os.listdir('datasets/test/5/val')
    ...
    for user_name in tqdm(file_list, desc="处理进度", ascii=True):
        ...
        data_loader_test = data.DataLoader(
            CPCDataset(
                csv_file='datasets/test/5/val/' + user_name,
